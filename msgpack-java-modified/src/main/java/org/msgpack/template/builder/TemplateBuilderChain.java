...
public class TemplateBuilderChain {
	...
	protected void reset(final TemplateRegistry registry, final ClassLoader cl) {
		...
		// FIXME
		// Javassist{,Beans}TemplateBuilder should be created with reflection
		// for android.
	...
	private static TemplateBuilder createForceTemplateBuilder(String className, TemplateRegistry registry,
			ClassLoader cl) {
		try {
