...
public class Introspector extends java.lang.Object {
	...
	/*
	 * MODIFIED FOR THE MSGPACK PROJECT Method which attempts to instantiate a
	 * BeanInfo object of the supplied classname
	 * 
	...
	private static BeanInfo loadBeanInfo(String beanInfoClassName, Class<?> beanClass) throws Exception {
		...
		return (BeanInfo) Class.forName(beanInfoClassName, true, Thread.currentThread().getContextClassLoader())
				.newInstance();
	}
