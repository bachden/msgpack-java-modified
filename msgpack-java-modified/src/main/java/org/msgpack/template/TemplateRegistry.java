...
public class TemplateRegistry {
	...
	public synchronized Template lookup(Type targetType) {
		...
		throw new MessageTypeException("Cannot find template for " + targetClass + " class.  "
	...
	private Template lookupGenericArrayTypeImpl(GenericArrayType genericArrayType) {
		...
		if (dim <= 0) {
			...
			throw new UnsupportedOperationException(
					String.format("Not implemented template generation of %s", genericArrayTypeName));
		}
	...
	private static boolean isPrimitiveType(String genericCompTypeName) {
		return (genericCompTypeName.equals("byte") || genericCompTypeName.equals("short")
				|| genericCompTypeName.equals("int") || genericCompTypeName.equals("long")
				|| genericCompTypeName.equals("float") || genericCompTypeName.equals("double")
				|| genericCompTypeName.equals("boolean") || genericCompTypeName.equals("char"));
	}
