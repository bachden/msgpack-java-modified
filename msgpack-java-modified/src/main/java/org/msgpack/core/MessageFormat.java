...
/**
 * Describes the list of the message format types defined in the MessagePack
 * specification.
 */
public enum MessageFormat {
	...
	static {
		// Preparing a look up table for converting byte values into
		// MessageFormat types
	...
	/**
	 * Converting a byte value into MessageFormat. For faster performance, use
	 * {@link #valueOf}
	 *
	 * @param b
	 *            MessageFormat of the given byte
