...
class SequentialMapValueImpl extends AbstractMapValue {
	...
	private static class EntrySetIterator implements Iterator<Map.Entry<Value, Value>> {
		...
		public Map.Entry<Value, Value> next() {
			 ...
			 *
			 *      msgpack-java was crashed on Android 2.2 or below because the
			 *      method calls java.util.AbstractMap$SimpleImmutableEntry that
			 *      doesn't exist in Android 2.2 or below.
			 */
	...
	// private boolean equalsValue(Value[] oarray, Value key, Value val, int
	// hint) {
