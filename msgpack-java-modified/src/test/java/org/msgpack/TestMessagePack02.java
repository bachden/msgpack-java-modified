...
public class TestMessagePack02 {
	...
	public static class TestUserDefinedTypeFieldsClassNotNullableBufferPackBufferUnpack
		...
		@Override
		public void testUserDefinedTypeFieldsClassNotNullable(UserDefinedTypeFieldsClassNotNullable v)
				throws Exception {
			MessagePack msgpack = new MessagePack();
			byte[] bytes = msgpack.write(v);
	...
	public static class TestReferenceCycleTypeFieldsClassNotNullableBufferPackBufferUnpack
		...
		@Override
		public void testReferenceCycleTypeFieldsClassNotNullable(ReferenceCycleTypeFieldsClassNotNullable v)
				throws Exception {
			MessagePack msgpack = new MessagePack();
			byte[] bytes = msgpack.write(v);
	...
	public static class TestReferenceCycleTypeFieldsClassNotNullableBufferPackConvert
		...
		public void testReferenceCycleTypeFieldsClassNotNullable(ReferenceCycleTypeFieldsClassNotNullable v)
			...
			byte[] bytes = msgpack.write(v);
			Value value = msgpack.read(bytes);
			ReferenceCycleTypeFieldsClassNotNullable ret = msgpack.convert(value,
					ReferenceCycleTypeFieldsClassNotNullable.class);
			assertEquals(v, ret);
		}
	}
	...
	public static class TestIndexedFieldsBeanClassNotNullableBufferPackBufferUnpack
			extends org.msgpack.template.builder.TestSet {
		@Test
		@Override
	...
	public static class TestIndexedFieldsBeanClassNotNullableBufferPackConvert
			extends org.msgpack.template.builder.TestSet {
		@Test
		@Override
		public void testIndexedFieldsBeanClassNotNullable() throws Exception {
	...
	public static class TestIndexedFieldsBeanClassNotNullableBufferPackUnpack
			extends org.msgpack.template.builder.TestSet {
		@Test
		@Override
		public void testIndexedFieldsBeanClassNotNullable() throws Exception {
	...
	public static class TestIndexedFieldsBeanClassNotNullablePackBufferUnpack
			extends org.msgpack.template.builder.TestSet {
		@Test
		@Override
		public void testIndexedFieldsBeanClassNotNullable() throws Exception {
	...
	public static class TestIndexedFieldsBeanClassNotNullableUnconvertConvert
			extends org.msgpack.template.builder.TestSet {
		@Test
		@Override
		public void testIndexedFieldsBeanClassNotNullable() throws Exception {
	...
	public static class TestMessagePackableTypeFieldsClassNotNullableBufferPackBufferUnpack
		...
		@Override
		public void testMessagePackableTypeFieldsClassNotNullable(MessagePackableTypeFieldsClassNotNullable v)
				throws Exception {
			MessagePack msgpack = new MessagePack();
			byte[] bytes = msgpack.write(v);
	...
	public static class TestMessagePackableTypeFieldsClassNotNullableBufferPackConvert
		...
		public void testMessagePackableTypeFieldsClassNotNullable(MessagePackableTypeFieldsClassNotNullable v)
			...
			byte[] bytes = msgpack.write(v);
			Value value = msgpack.read(bytes);
			MessagePackableTypeFieldsClassNotNullable ret = msgpack.convert(value,
					MessagePackableTypeFieldsClassNotNullable.class);
			assertEquals(v, ret);
		}
	}
