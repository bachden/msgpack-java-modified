...
public class TestReadTemplate {
	...
	public void testReadTemplateNull() throws IOException {
		...
		Map<String, Integer> tmap = u().read(Templates.tMap(Templates.TString, Templates.TInteger));
		assertNull(tmap);

		Collection<Long> tcollection = u().read(Templates.tCollection(Templates.TLong));
