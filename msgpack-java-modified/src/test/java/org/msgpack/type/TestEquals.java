...
public class TestEquals extends TestSet {
	...
	public void testMapOrder() throws Exception {
		Value v1 = ValueFactory.createMapValue(new Value[] { ValueFactory.createRawValue("k0"),
				ValueFactory.createNilValue(), ValueFactory.createRawValue("k1"), ValueFactory.createRawValue("v1"),
				ValueFactory.createRawValue("k2"), ValueFactory.createRawValue("v2"), ValueFactory.createRawValue("k3"),
				ValueFactory.createRawValue("v3"), ValueFactory.createRawValue("k4"), ValueFactory.createRawValue("v4"),
				ValueFactory.createRawValue("k5"), ValueFactory.createRawValue("v5"), ValueFactory.createRawValue("k6"),
				ValueFactory.createRawValue("v6"), ValueFactory.createRawValue("k7"), ValueFactory.createRawValue("v7"),
				ValueFactory.createRawValue("k8"), ValueFactory.createRawValue("v8"), ValueFactory.createRawValue("k9"),
				ValueFactory.createRawValue("v9"), ValueFactory.createRawValue("k10"),
				ValueFactory.createRawValue("v10"), ValueFactory.createRawValue("k11"),
				ValueFactory.createRawValue("v11"), ValueFactory.createRawValue("k12"),
				ValueFactory.createRawValue("v12"), ValueFactory.createRawValue("k13"),
				ValueFactory.createRawValue("v13"), ValueFactory.createRawValue("k14"),
				ValueFactory.createRawValue("v14"), ValueFactory.createRawValue("k15"),
				ValueFactory.createRawValue("v15"), ValueFactory.createRawValue("k16"),
				ValueFactory.createRawValue("v16"), ValueFactory.createRawValue("k17"),
				ValueFactory.createRawValue("v17"), ValueFactory.createRawValue("k18"),
				ValueFactory.createRawValue("v18"), ValueFactory.createRawValue("k19"),
				ValueFactory.createRawValue("v19"), });
		Value v2 = ValueFactory.createMapValue(new Value[] { ValueFactory.createRawValue("k3"),
				ValueFactory.createRawValue("v3"), ValueFactory.createRawValue("k11"),
				ValueFactory.createRawValue("v11"), ValueFactory.createRawValue("k4"),
				ValueFactory.createRawValue("v4"), ValueFactory.createRawValue("k10"),
				ValueFactory.createRawValue("v10"), ValueFactory.createRawValue("k5"),
				ValueFactory.createRawValue("v5"), ValueFactory.createRawValue("k6"), ValueFactory.createRawValue("v6"),
				...
				ValueFactory.createRawValue("k0"), ValueFactory.createNilValue(), ValueFactory.createRawValue("k1"),
				ValueFactory.createRawValue("v1"), ValueFactory.createRawValue("k2"), ValueFactory.createRawValue("v2"),
