...
public class TestSet {
	...
	public void testFloatArray() throws Exception {
		...
		testFloatArray(new float[] { Float.MAX_VALUE, Float.MIN_VALUE, Float.NaN, Float.NEGATIVE_INFINITY,
	...
	public void testDoubleArray() throws Exception {
		...
		testDoubleArray(new double[] { Double.MAX_VALUE, Double.MIN_VALUE, Double.NaN, Double.NEGATIVE_INFINITY,
